...
f=open('C:\\Users\\Alvi Rahman\\Desktop\\Farhana Miss\\allUser.txt','r', encoding='utf-8')
allusers=f.readlines()
f.close()

fnf=open('C:\\Users\\Alvi Rahman\\Desktop\\Farhana Miss\\fnf2.txt',"w", encoding="UTF-16")
...
for f in range(14147,len(allusers)):
